...
load(sprintf('../data/exp_num_%d.mat', exp_num))
...
delete([plt_TV_opt, plt_EV_opt])

%% Save the movie
[file,path] = uiputfile(sprintf('../movies/offline/offline_exp_%d.mp4', exp_num));
