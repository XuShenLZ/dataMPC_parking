function [hyp_xy, hyp_w, hyp_b] = get_extreme_pt_hyp(p, dir, x, y, theta, w, l, r)  
    ...
    [x_local, y_local, hyp_w_local, hyp_b_local] = get_collision_boundary_point(p_loc(1), p_loc(2), phi_loc, w, l, r);
