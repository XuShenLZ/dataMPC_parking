classdef ObcaController < MpcController
	properties
		G
		g
		dmin = 0.001;
	...
	methods
		%% ObcaController: constructor
		function self = ObcaController(N, EV)
			disp('Constructing Obca controller');
		...
		function [z_opt, u_opt, err] = solve(self, z0, u0, z_ref, TV_pred, EV)

			tic

			disp('Solving Obca Controller');
