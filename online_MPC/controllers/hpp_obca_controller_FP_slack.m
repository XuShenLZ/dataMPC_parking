classdef hpp_obca_controller_FP_slack
	properties
        ws_params;
        opt_params;
	...
	methods
		function self = hpp_obca_controller_FP_slack(regen, ws_params, opt_params)
            ...
            if ~exist(strcat(opt_params.name, '.m'), 'file') || regen
                ...
                generate_forces_pro_opt_solver_slack(opt_params);
                fprintf('\n')
            end
