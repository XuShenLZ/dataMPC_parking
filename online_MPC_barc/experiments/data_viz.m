...
EV.ref_z = [EV.ref_z(1,:)*scaling_factor; EV.ref_z(2,:)*scaling_factor; EV.ref_z(3,:); EV.ref_z(4,:)*scaling_factor];
...
for t = 1:T_total
	...
	[pEV, cEV] = plotCar(EV.traj(1, t), EV.traj(2, t), EV.traj(3, t), EV_W, EV_L, plt_ops);
	hold on
