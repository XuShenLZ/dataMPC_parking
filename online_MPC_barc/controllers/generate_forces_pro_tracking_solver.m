...
%     nh = zeros(opt_model.N,1); 
    ...
    for i = 1:opt_model.N-1
        ...
        % [x_k, u_k]
        nvar(i) = n_x + n_u;
        ub{i} = [inf*ones(n_x,1); inf*ones(n_u,1)];
        lb{i} = [-inf*ones(n_x,1); -inf*ones(n_u,1)];
