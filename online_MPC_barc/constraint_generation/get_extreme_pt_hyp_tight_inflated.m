function [hyp_xy, hyp_w, hyp_b] = get_extreme_pt_hyp_tight_inflated(p, dir, x, y, theta, w, l, r, vel_dir, scaling)  
    ...
    [x_local, y_local, hyp_w_local, hyp_b_local] = get_collision_boundary_point_tight_inflated(p_loc(1), p_loc(2), phi_loc, ...
        w, l, r, vel_dir, scaling);
